...
Here at Webiny, we are certainly excited about the newest AWS addition and we’ll be using it to power our serverless CMS, which you will be able to check out [here](https://www.webiny.com) in a couple of weeks from now. In the meantime, you can follow us via [Twitter](https://twitter.com/WebinyCMS) if you want to know more.
