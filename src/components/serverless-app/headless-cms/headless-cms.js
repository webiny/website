...
export default ({ children, ...props }) => (
  <React.Fragment>
    ...
    >
      <List>
        ...
        <ListItem title={"GraphQL APIs"}>
          - There are 2 APIs, one for content management and one for content
          delivery.
        </ListItem>
    ...
    <ContentContainer className={featureContainer}>
      <FeatureBox>A true headless CMS, that's also serverless</FeatureBox>
      <FeatureBox>Save 60-80% on your cloud hosting bill</FeatureBox>
      <FeatureBox>Stop paying for stuff you don't use</FeatureBox>
    </ContentContainer>
    <ContentContainer className={featureContainer}>
      <FeatureBox>Multi-language support out-of-the-box</FeatureBox>
      <FeatureBox>Manage your files and media assets</FeatureBox>
      <FeatureBox>
    ...
    <ContentContainer>
      ...
      <Grid left>
        ...
        <Cell title="Content Modeling">
          <p>
            Powerful modelling features allow you to model the content and
            define relationships using a simple drag&drop editor.
          </p>
          <p>
            At the same time, you are also building the UI for the input forms.
            Ensuring your editors have a pleasant user-experience while working
            with your content.
          </p>
          <p>
            <a
      ...
      <Grid right>
        <Cell title="Content Localization">
          <p>
            The localization support is built into the core of Webiny Headless
            CMS. All your content is translateable and distributable in several
            languages.
          </p>
          <p>
            Each editor chooses the languages they are working on. They can also
            instantly see the values of a specific field on all other languages.
          </p>
          <p>
            <a
      ...
      <Grid left>
        ...
        <Cell title="GraphQL API + Playground">
          <p>
            ...
            On top of that, Webiny exposes a GraphQL Playground you can use to
    ...
    <ContentContainer>
      <Grid right>
        <Cell title="Asset Management">
          <p>
            Webiny File Manager is integrated directly into the Headless CMS
            giving you a whole asset management solution with integrated
      ...
      <Grid left>
        ...
        <Cell title="Environments">
          <p>
            Environments are a powerful feature in Webiny Headless CMS. Creating
            a new environment copies all the data and all the models from the
            current environment. This allows you to make changes and prepare new
            content in the background, while still serving production content
      ...
      <Grid right>
        <Cell title="Aliases">
          <p>
            Aliases go in hand with environments. Each environment is linked to
            an alias, which defines the GraphQL endpoint and which content and
            model are going to be served.
          </p>
          <p>
            An alias can be unlinked from one environment and linked to another
            environment. This allows instant switching between different version
            of your content, as well as instant rollbacks.
          </p>
          <p>
            <a
    ...
    <ContentContainer>
      <Grid right>
        ...
        <Cell title="Access Tokens">
          <p>
            The authentications and permissions are part of the Webiny core
            package and they also pass on to the Headless CMS. Create users,
            user groups, roles and permissions to control who and how they
            access the system.
          </p>
          <p>
            In addition to roles and permissions, each user can control their
            own set of personal access tokens. Each token is assigned to one or
            more environments.{" "}
          </p>
          <p>
            <a
      ...
      <Grid left>
        <Cell title="Content Model Groups">
          <p>
            Webiny features a menu component that is extended via the content
            models from the Headless CMS. This allows you to build great backend
            experience for your team, making it easy and intuitive for them to
      ...
      <Grid right>
        ...
        <Cell title="Device & Frontend Agnostic">
          <p>
            Webiny Headless CMS integrates with any web framework and even goes
            beyond that. Anything from building a website on top of Gatsby.js or
            using Swift and displaying the content on an Apple Watch is
            supported.
          </p>
          <p>
            <a
