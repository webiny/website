    ...
    >
      <List>
        <ListItem title={"Build Serverless Apps FASTER"}>
          - All-in-one framework designed from ground up specifically for
          development of serverless applications.
        </ListItem>
        <ListItem title={"Everything you need"}>
          - ACL layer, Apollo GraphQL API, Admin UI, deployment mechanism, SSR,
          webpack & babel configurations, React components and much more.
        </ListItem>
        <ListItem title={"Just add business logic"}>
          - All is pre-configured so you can start coding your app right away
          without losing time on bootstrap and setup.
        </ListItem>
      </List>
    </Hero>
      ...
      <ContentContainer>
        ...
        <Grid right>
          <Cell title="Install via Yarn">
            <p>
              To configure and install the complete environment, it’s a simple
              `yarn` command and just one configuration file. Learn more >
            </p>
          </Cell>
          <Cell>
            <Code language="shell">
...
https://xyz.amazonaws.com/`}
        ...
        <Grid right>
          <Cell title="Webiny CLI">
            <p>
              Webiny CLI is the tool that you will use to build, watch and
              deploy your serverless applications.
            </p>
            <p>
              CLI supports command like deploying only a specific service/API
              instead of the whole set, for much faster development experience.
            </p>
            <p>
              CLI will also notify you via desktop notifications when the
              deployment is done, so you don’t need to watch the terminal all
              the time.
            </p>
          </Cell>
          <Cell>
        ...
        <Grid right>
          <Cell title="Powered by plugins">
            <p>
              ...
              properties, and any other custom ones that you might need to get
              the job done.
            </p>
          </Cell>
          <Cell>
        ...
        <Grid right>
          <Cell title="Routes">
            <p>
              ...
              different! Adding new routes to your app is just a matter of
              creating a simple "route" plugin.
            </p>
          </Cell>
          <Cell>
            <Code language="javascript">
...

{
    ...
    route: (
        ...
        <Grid right>
          <Cell title="Menus">
            <p>
              What good are routes if you cannot access them via the user
              interface. But don't worry, Webiny's got you covered here as well!
              With "menu" plugins, you can easily create menus that can be
              organized in any way you like.
            </p>
          </Cell>
          <Cell>
            <Code language="jsx">
  ...
  render({ Menu, Section, Item }) {
    return (
      <Menu name="my-app" label={"My App"}>
        ...
        <Grid right>
          <Cell title="GraphQL">
            <p>
              All Webiny apps are powered by a GraphQL HTTP API which can be
              easily expanded with new fields, types, and resolvers. Creating a
              simple "graphql-schema" plugin is all that is needed in order to
              do that.
            </p>
          </Cell>
          <Cell>
    ...
    schema: {
        ...
        <Grid right>
          <Cell title="Models">
            <p>
              For all database-related tasks, Webiny relies on the Commodo
              library, which is basically a set of higher order functions (HOFs)
              that let you define rich data model objects. Once you've defined
              your models, you can selectively expose needed data and
              functionality via your GraphQL schema.
            </p>
          </Cell>
          <Cell>
            <Code language="javascript">
