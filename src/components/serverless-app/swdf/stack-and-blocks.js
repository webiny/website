    ...
    return (
      <React.Fragment>
        <section>
          ...
          <Text>
            While building Webiny CMS we faced a lot of challenges. From
            architecture and performance to webpack configurations and
            deployments. Serverless is still a new thing on the market. It's
            hard to learn all the best practices and get all the tools and
            libraries working together.
          </Text>
          <Text>
            This is why we build the Serverless Web Development Framework. So
            you focus on your business logic and leave the heavy-lifting to the
            framework.
          </Text>
          <Text>
            Using this framework, we built the Webiny apps, such as the Headless
            CMS, Page Builder and others. You can rest assured that it works, it
            scales and it's easy to use.
          </Text>
          <img
