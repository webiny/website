...
export default ({ children, ...props }) => (
  <React.Fragment>
    ...
    <ContentContainer className={featureContainer}>
      <FeatureBox>Integrated throughout all Webiny apps</FeatureBox>
      <FeatureBox>Built-in image editor</FeatureBox>
      <FeatureBox>
        Select and upload a single, or multiple files in one go
      </FeatureBox>
    </ContentContainer>
    <ContentContainer className={featureContainer}>
      <FeatureBox>Tag files for better search results</FeatureBox>
      <FeatureBox>A component you can integrate into your own apps</FeatureBox>
      <FeatureBox>It can work with any 3rd party storage service</FeatureBox>
    </ContentContainer>
      ...
      <ContentContainer>
        ...
        <Grid left>
          ...
          <Cell title="Just drop your files">
            <p>
              You can drop a single file, or multiple files at once. In case
              drag&drop is not handy, you can use the upload button at the top
              to add your files.
            </p>
          </Cell>
        </Grid>
        <Grid right>
          <Cell title="Built-in image editor">
            <p>
              Images are often the types of files that need that extra touch.
              With File Manager, you can manipulate an image and apply different
              filter to it right there from within the UI. It will create a copy
              of the original image, so you never lose the source file.
            </p>
          </Cell>
          <Cell>
        ...
        <Grid left>
          ...
          <Cell title="Find the right files with ease">
            <p>
              There is an always-visible search bar at the top of the screen.
              Any word you type in, the system will try to match against the
              file name, any of the tags or the file label. This makes it easy
        ...
        <Grid right>
          <Cell title="Tag and organize files">
            <p>
              Tags are visible on the left side of the screen. They act similar
              to a folder. Clicking a tag, will only show images that have that
              tag applied. You can always create new tags by simply tagging an
              image.
            </p>
          </Cell>
          <Cell>
        ...
        <Grid left>
          ...
          <Cell title="Don't worry about about how many files you have">
            <p>
              In some cases, when you have a big number of images, they can slow
              down the load time it takes to display all that content on your
              screen. Often systems introduce pagination to avoid that, but
              that's clumsy to use. Webiny File Manager uses an infinitive
              scroll and lazy loading mechanism. This way the content is
