        ...
        <ContentContainer>
          <BoxContainer>
            <Box>
              ...
              <BoxDescription>
                ...
                safe environment that is automatically managed for you. So no
                more worries about patching your systems, more efficient cost,
            ...
            <Box>
              ...
              <BoxDescription>
                ...
                set as the minumum requirement for all the server side
                components.
              </BoxDescription>
              <BoxFooter>
          ...
          <BoxContainer>
            ...
            <Box>
              ...
              <BoxDescription>
                ...
                so are we! Therefore we invested extra effort into creating
                ours.
              </BoxDescription>
              <BoxFooter>
          ...
          <BoxContainer>
            <Box>
              ...
              <BoxDescription>
                Although Webiny comes with a frontend for your website, that
                part is optional. You can use existing, or build a new, frontend
                in any language or technology. Just use our GraphQL API to
                retrieve and display your content.
              </BoxDescription>
              <BoxFooter>
                <ExternalLink href="#">
            ...
            <Box>
              ...
              <BoxDescription>
                Every website requires a theme. At Webiny we provide one based
                on the latest Google Material UI, which can be adapted to fit
                any brand requirements and pretty much any visual style.
              </BoxDescription>
              <BoxFooter>
                <ExternalLink href="#">
          ...
          <BoxContainer>
            <Box>
              ...
              <BoxDescription>
                ...
                called “Entities” is designed for working with GraphQL, as well
                as it’s easy to use and flexible enough to support any use case.
              </BoxDescription>
              <BoxFooter>
            ...
            <Box>
              ...
              <BoxDescription>
                ...
                best practices, are managed as part of the business logic.
                Webiny also supports multiple middlewares for authentication
                providesr, so you can easily hook a custom provider like SSO.
              </BoxDescription>
              <BoxFooter>
