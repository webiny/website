          ...
          <Grid top className={containerStyle}>
            ...
            <div>
              ...
              <Cell title="Microservice architecture">
                <p>
                  ...
                  microservices inside scaleable serverless functions. There is
            ...
            <div>
              ...
              <Cell title="Everything you need is included">
                <p>
                  Seamless development experience, faster project turnaround
                  time, fewer bugs and greater quality output.
                </p>
              </Cell>
            </div>
