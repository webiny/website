...
export default ({ children, ...props }) => (
    <ContentContainer>
        ...
        <SubText>These are some of our options to get you started.</SubText>
        <PricingWrapper>
            <Package className={"freelancer"}>
                ...
                <BetaBoxWrapper>
                    <BetaBox>
                        ...
                        <strong>Beta Period:</strong> During the beta, this package is available
                        free of charge. No credit card is required, later you can decide if you want
                        to upgrade to the paid package.
                    </BetaBox>
                </BetaBoxWrapper>
                ...
                <PackageFeatures>
                    ...
                    <li data-tip data-for="freelancer-deployments">
                        100 Deployments
                    </li>
            ...
            <Package className={"agency"}>
                ...
                <Price>$499</Price>
                <PriceDescription>per website per month</PriceDescription>
                <Button className={button} fullWidth={true} type="outlineDark" link="/contact-us">
                    <container>
                        Talk to us
                ...
                <PackageFeatures>
                    ...
                    <li data-tip data-for="agency-deployments">
                        1.000 Deployments
                    </li>
                    ...
                    <li data-tip data-for="agency-consultation">
                        Consultation Service
                    </li>
                    <li data-tip data-for="agency-band-pricing">
                        Band Pricing
                    </li>
                </PackageFeatures>
            </Package>
            <Package className={"enterprise"}>
                ...
                <Button className={button} fullWidth={true} type="outline" link="/contact-us">
                    <container>
                        Talk to us
                        <Arrow alt="Get Started" src={arrow} />
                    </container>
                ...
                <PackageFeatures>
                    <li data-tip data-for="api-calls">
                        Training & Onboarding
                    </li>
        ...
        <ExtraWrapper>
            ...
            <p>
                For when you run out and need extra resources. The price is per usage-package, and
      ...
      */}
        ...
        <Tooltip id="freelancer-api-calls">Call your website APIs up to 50k times.</Tooltip>

        <Tooltip id="freelancer-db-storage">
            Your own database which can store up to 250MB of data and indexes. Note: file storage is
            unlimited and is separate from DB storage.
        </Tooltip>
        ...
        <Tooltip id="agency-api-calls">Call your website APIs up to 1 million times.</Tooltip>

        <Tooltip id="agency-db-storage">
            Your own database which can store up to 1GB of data and indexes. Note: file storage is
            unlimited and is separate from DB storage.
        </Tooltip>
