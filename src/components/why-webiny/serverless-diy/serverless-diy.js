        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    ...
                    <SubTitle>
                        So far, because of the lack of tooling solutions majority of companies that
                        have decided to develop serverless&nbsp; applications had to do this by
                        taking the long and painful process of building the custom tooling
                        themselves. Webiny now provides you with a simple solution that eliminates
                        all those challenges and allows you to focus your time completely on your
                        business logic.
                    </SubTitle>
                    <BenefitBox>
