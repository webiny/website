...
export const CONTENT_LIST = [
    {
        ...
        description: 'We have estimated that you’d need to dedicate a minimum of 780 full working days split between your team in order to overcome these challenges by taking the DIY route. This is the time it took us to build Webiny. By using Webiny you can skip this whole part and start building serverless products much faster. ',
