        ...
        return (
            <WhyServerlessSection {...this.props}>
                <ContentContainer className={whyServerlessContainerClass}>
                    ...
                    <Text>
                        We like to say Webiny is the easiest way to adopt serverless. Webiny has
                        already solved these and many more challenges for you, so you can skip these
                        pitfalls, save a ton of time, and go straight into building your project.
                    </Text>
                    <ImageWrapper>
                        <img
