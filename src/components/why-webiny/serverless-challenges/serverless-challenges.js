        ...
        return (
            <WhyServerlessSection {...this.props}>
                <ContentContainer className={whyServerlessContainerClass}>
                    ...
                    <SubTitle>
                        Transition to serverless unfortunately doesn’t come without a series of
                        challenges you’ll need to overcome. A survey done on over 1500 companies,
                        that were moving to serverless, has shown us what are the biggest challenges
                        why an organisation hasn’t yet adopted serverless or the challenges they are
                        facing after the adoption:
                    </SubTitle>
                    <SliderWrapper>
