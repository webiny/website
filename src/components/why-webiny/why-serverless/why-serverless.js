      ...
      <WhyServerlessSection {...this.props}>
        <ContentContainer className={whyServerlessContainerClass}>
          ...
          <SubTitle>
            ...
            By moving to serverless you are estimated to save between
            {' '}
            <span>
              {' '}
              60% and 80% of your infrastructure and maintenance costs.
              {' '}
            </span>
            <br />
          ...
          <BenefitsWrapper>
            <BenefitBox>
              <div className={'text-content'}>
                ...
                <p className={'body'}>
                  ...
                  They are not your problem anymore, the same goes for load balancers, autoscaling and many other operations.
                </p>
              </div>
            ...
            <BenefitBox className={rightToLeftClass}>
              <div className={'text-content'}>
                ...
                <p className={'body'}>
                  Pay per function execution and not per hour. You no longer need to over-provision and over-pay for infrastructure.
                  Especially in preparation for those periods of peak demand.
                </p>
              </div>
              <div className={'media-content'}>
                <div className={'img-wrapper'}>
            ...
            <BenefitBox className={rightToLeftClass}>
              <div className={'text-content'}>
                ...
                <p className={'body'}>
                  Serverless functions spin up in milliseconds the moment there is an increase in the demand.
                  The newly created functions are immediately ready to handle new requests. And you, just sit back and relax.
                </p>
              </div>
              <div className={'media-content'}>
                <div className={'img-wrapper'}>
