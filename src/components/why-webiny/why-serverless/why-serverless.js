        ...
        return (
            <WhyServerlessSection {...this.props}>
                <ContentContainer className={whyServerlessContainerClass}>
                    ...
                    <SubTitle>
                        Serverless is making big changes to how we operate, deploy, architect and
                        run applications. By moving to serverless you are estimated to save between{" "}
                        <span> 60% and 80% of your infrastructure and maintenance costs. </span>
                        <br />
                    ...
                    <BenefitsWrapper>
                        <BenefitBox>
                            <div className={"text-content"}>
                                <h2 className={"title"}>
                                    <span>Forget</span> about server management
                                </h2>
                                <p className={"body"}>
                                    Servers are still there, but they are abstracted away and
                                    managed by your cloud provider. They are not your problem
                                    anymore, the same goes for load balancers, autoscaling and many
                                    other operations.
                                </p>
                            </div>
                        ...
                        <BenefitBox className={rightToLeftClass}>
                            <div className={"text-content"}>
                                ...
                                <p className={"body"}>
                                    Pay per function execution and not per hour. You no longer need
                                    to over-provision and over-pay for infrastructure. Especially in
                                    preparation for those periods of peak demand.
                                </p>
                            </div>
                            <div className={"media-content"}>
                                <div className={"img-wrapper"}>
                        ...
                        <BenefitBox>
                            <div className={"text-content"}>
                                <h2 className={"title"}>
                                    <span>Build</span> things faster
                                </h2>
                                <p className={"body"}>
                                    Because all you need to do is deploy your code, you won't lose
                                    time on spinning up and configuring servers. As a result you’ll
                                    iterate and launch products faster.
                                </p>
                            </div>
                            <div className={"media-content"}>
                                <div className={"img-wrapper"}>
                        ...
                        <BenefitBox className={rightToLeftClass}>
                            <div className={"text-content"}>
                                <h2 className={"title"}>
                                    <span>No more</span> scaling headaches
                                </h2>
                                <p className={"body"}>
                                    Serverless functions spin up in milliseconds the moment there is
                                    an increase in the demand. The newly created functions are
                                    immediately ready to handle new requests. And you, just sit back
                                    and relax.
                                </p>
                            </div>
                            <div className={"media-content"}>
