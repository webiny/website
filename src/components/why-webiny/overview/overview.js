                ...
                <Section {...this.props}>
                    <ContentContainer className={overviewContainerClass}>
                        <OverviewSectionWrapper>
                            <Title>
                                Infrastructure has <TitleHighlight>evolved.</TitleHighlight>
                                <br />
                                So did the tools we use to build the web.
                            </Title>
                            <SubTitle>
                                Webiny makes it easy to build websites, apps and APIs on top of
                                serverless infrastructure like AWS Lambda.
                            </SubTitle>
                            <Caption>
