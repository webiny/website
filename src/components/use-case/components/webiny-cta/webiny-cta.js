...
const primaryCTA = {
  ...
  body: "We understand that no project is the same. If you want to ensure that Webiny is the right platform for you, book a call with us and we'll happily answer any questions you have.",
...
const WebinyPrimaryCTAComponent = ({className, cta = primaryCTA}) => (
  <SectionWithPurpleWave className={className}>
    <ContentContainer
      className={containerClass + ' ' + primaryCTAContainerClass}
    >
      <WebinyAppsWrapper>
