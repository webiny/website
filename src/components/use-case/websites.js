    ...
    <ContentContainer>
      <Grid left>
        ...
        <Cell title="Build pages and forms without code">
          <p>
            Use the intuitive and powerful drag&drop builder to create stunning
            pages and forms to capture your leads. No coding knowledge required.
          </p>
        </Cell>
      </Grid>
      <Grid right>
        ...
        >
          <p>
            There is a UI and an API for content modeling and a GraphQL API for
            content distribution. The headless module allows you to go beyond
            the web to distribute and display your content.
          </p>
        </Cell>
        <Cell>
          <img src={imgHeadless} />
      ...
      <Grid right>
        <Cell title="Use the ready-made integrations or create your own">
          <p>
            Things like youtube videos, cookie policy consents, google tag
            manager and many more, are all included by default. If something is
            missing, it's easy to create a new plugin.
          </p>
        </Cell>
        <Cell>
      ...
      <Grid left>
        ...
        <Cell title="Build your own theme">
          <p>
            Webiny allows you to create your theme. Have full control over your
            HTML and CSS. You can also import any library from NPM to help you
            create added functionality.
          </p>
        </Cell>
      </Grid>
      <Grid right>
