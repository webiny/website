  ...
  <React.Fragment>
    <ContentContainer className={containerStyle + " " + hero}>
      <IntroTextWrapper>
        ...
        <IntroText>
          To show our appreciation to all our contributors and supporters, we
          are giving away free swag. The section below defines what swag is
          available, and how you can claim yours.
        </IntroText>
        <IntroText>
          <Bold>Why are we doing this?</Bold>
          <br />
          An open-source project, such as ours, can’t exist without a community
          around it. The community contributes and improves the project. This is
          the secret ingredient to a great open-source product. At Webiny we
          decided to offer a little token of appreciation to all our community
          members.
        </IntroText>
        <IntroText>
          This might look like free marketing, but our goal is sincere. Building
          a community around Webiny and advancing the adoption of serverless
          technology.
        </IntroText>
        <IntroText>
    ...
    <ContentContainer className={containerStyle}>
      ...
      <Grid left>
        ...
        <Cell title="Become a Fan">
          <p>
            A fan is someone who loves what we do here. Fans give us support to
            keep going forward. And everything we do, we do it for them. A
            Webiny fan is someone who 1.) starred our{" "}
      ...
      <Grid right>
        <Cell title="Spread the Knowledge">
          <p>
            You have created a blog post, a tutorial or a video guide for Webiny
            related content? We would love to know about it, so we can spread
            the word through our channels. On top of that, we’ll send you a
            Webiny branded t-shirt.
          </p>
        </Cell>
        <Cell>
          <img
      ...
      <Grid left>
        ...
        <Cell title="Show us Your Work">
          <p>
            ...
            runs on Webiny? Or if you have created a Webiny plugin? If so,
            please send it over, and we’ll have a look and send you some
            stickers in return. Selected projects and teams have the chance to
      ...
      <Grid right>
        <Cell title="Our Thanks to All Contributors">
          <p>
            Got your first Webiny PR merged, that’s awesome! Thank you so much
            for contributing your time to our project. Expect this small token
            of appreciation. We will also add you to our contributors' page, as
            well as promote your profile on our website.
          </p>
        </Cell>
        <Cell>
          <img
      ...
      <ContentContainer className={containerStyle}>
        ...
        <ClaimNote>
          * The provided information{" "}
          ...
          be shared with any 3rd parties. We just need the details to know where
      ...
      <ContentContainer className={containerStyle}>
        <Grid left>
          ...
          <Cell className={ambassadorContent}>
            ...
            <p>
              If you organized a Webiny meetup group, or want to organize one,
            ...
            <p>
              For active ambassadors, we can go a step further. If you enjoy
              educating others, love building communities, organizing meetups,
              attending conferences, and spreading the word about Webiny, we are
              ready to offer you a full-time paid position in our team.
            </p>
            <p>To apply, please send your CV to info@webiny.com.</p>
          </Cell>
        </Grid>
      </ContentContainer>
    </section>
