    ...
    <React.Fragment>
        <ContentContainer className={containerStyle + " " + hero}>
            <IntroTextWrapper>
                ...
                <IntroText>
                    ...
                    ingredient to a great open-source product. At Webiny we decided to offer a
                ...
                <IntroText>
                    ...
                    community around Webiny and advancing the adoption of serverless technology.
                </IntroText>
                <IntroText>
        ...
        <ContentContainer className={containerStyle}>
            ...
            */}
            <Grid right>
                ...
                <Cell>
                    <img className={swagImage} src={webinyShirt} alt="Webiny SWAG - Shirt" />
                </Cell>
            </Grid>
            <Grid left>
                <Cell>
                ...
                <Cell title="Show us Your Work">
                    <p>
                        ...
                        Webiny? Or if you have created a Webiny plugin? If so, please send it over,
            ...
            <Grid right>
                <Cell title="Our Thanks to All Contributors">
                    <p>
                        Got your first Webiny PR merged, that’s awesome! Thank you so much for
        ...
        <section className={claimSwagBlock}>
            <ContentContainer className={containerStyle}>
                ...
                <p>Send an email to community@webiny.com with the following information:</p>
                <ClaimInstructions>
                    <div>
            ...
            <ContentContainer className={containerStyle}>
                <Grid left>
                    ...
                    <Cell className={ambassadorContent}>
                        ...
                        <p>
                            If you organized a Webiny meetup group, or want to organize one, we are
                        ...
                        <p>
                            ...
                            conferences, and spreading the word about Webiny, we are ready to offer
