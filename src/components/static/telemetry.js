...
export default ({ children, ...props }) => (
  <Body title={"Telemetry"}>
    <div>
      ...
      <p>
        We highly value your privacy. We have created this page to be fully
        transparent about the information we collect. How we use the
        information, and what options you have to opt-out. We want to add that
        this data doesn't reveal a single identifiable information of you as an
        individual. We use the data in an honest way and with a single purpose -
        improving Webiny as a product for yourself and the wider community.
      </p>
      ...
      <List>
        ...
        <dt>5) Timestamp</dt>
        <dd>
          Why: So we can track the trends between when different operations are
          invoked.
        </dd>
        <dt>6) Current Webiny version</dt>
        <dd>
          Why: It's important to determine how backwards compatible new releases
          should be, as well as providing a migration path.
        </dd>
      </List>
      <h3>What is the information used for?</h3>
      <p>
        We use the information for improving the product and understanding usage
        patterns. This helps us to build a better experience, focus on the
        important features, and fix the most urgent bugs.
      </p>
      <h3>Can I opt-out?</h3>
      <p>
