      ...
      <Grid top className={containerStyle}>
        <div>
          ...
          <Cell title="Forget about server management">
            <p>
              Servers are still there, but they are abstracted away and managed
              by your cloud provider. They are not your problem anymore, the
              same goes for load balancers and autoscaling.
            </p>
          </Cell>
        </div>
        <div>
          ...
          <Cell title="Stop paying for stuff you don't use">
            <p>
              ...
              over-provision and thus over-pay for infrastructure. Especially
              for those periods of peak demand.
            </p>
          </Cell>
        </div>
        <div>
        ...
        <div>
          ...
          <Cell title="No more scaling headaches">
            <p>
              ...
              demand increase. The newly created functions are immediately ready
              to handle new requests. And you, just sit and relax.
            </p>
          </Cell>
        </div>
      </Grid>
