    ...
    <ContentContainer className={container}>
      <Box>
        <BoxInner>
          ...
          <Desc>
            We know your clients count on you to resolve any problems they might
            have in the shortest possible time. Having priority support when
            contacting us ensures your tickets get addressed with the same
            expectation.
          </Desc>
        </BoxInner>
      ...
      <Box>
        ...
        <BoxInner>
          ...
          <Desc>
            ...
            environment will be isolated from others, making sure there are no
            noisy neighbours interfering with your client websites.
          </Desc>
        </BoxInner>
      </Box>
      ...
      <Box>
        <BoxInner>
          ...
          <Desc>
            Webiny allows your team to have master account, for controlling
            access to all websites, as well as handling billing. Under each
            website you can have individual users with tailor-made roles and
            permissions, giving you fine-grain control over access rights.
          </Desc>
        </BoxInner>
        <BoxInner className={alignRight}>
      ...
      <Box>
        ...
        <BoxInner>
          ...
          <Desc>
            Removing the technology worry and complexity out of the way, enables
            you to create additional value for your clients, cut production time
