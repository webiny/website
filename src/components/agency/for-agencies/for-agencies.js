      ...
      <section {...this.props} className={wrapperClass}>
        <ContentContainer className={contentContainerClass}>
          <TextWrapper>
            ...
            <SubTitle>
              Webiny is 100% free and open-source and on top of that, our dev
              team is on standby to help your in-house team learn and adopt
              Webiny - all free of cost. We want you to give Webiny a try on a
              project and let us know your feedback and how we can make it
            ...
            <SolutionsWrapper>
              <SolutionCard>
                ...
                <p>
                  ...
                  small website, a heavy-duty web application or a
                  super-scaleable API.
                </p>
              </SolutionCard>
              <SolutionCard>
              ...
              <SolutionCard>
                <CheckBoxImage src={checkBoxIcon} alt="check mark" />
                <p>
                  A product with no-lock in - it's open-source and hosted on
                  your own AWS cloud. Customize it and adapt it in any way it
                  suits your project.
                </p>
              </SolutionCard>
              <SolutionCard>
            ...
            <SubText size={28}>
              ...
              <HighlightedBg>save over 60%</HighlightedBg> in your
              infrastructure cost.
            </SubText>
          </TextWrapper>
        </ContentContainer>
