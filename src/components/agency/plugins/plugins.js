      ...
      <section {...restProps} className={wrapperClass}>
        <ContentContainer className={contentContainerClass}>
          <TextWrapper>
            ...
            <SubTitle>
              Webiny is meant to be extended and customized via plugins. You can
              easily add your own plugins and integrate with systems like
              Stripe, Shopify, Mailchimp and others.
            </SubTitle>
          </TextWrapper>
          <Button
