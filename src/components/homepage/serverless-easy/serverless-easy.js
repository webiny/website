                ...
                <ContentContainer className={contentContainerClass}>
                    ...
                    <Wrapper>
                        <ReasonBox>
                            ...
                            <p className="text">
                                Webiny has been made with the developer in mind. It helps them
                        ...
                        <ReasonBox>
                            ...
                            <p className="text">
                                Webiny is created and maintained by an amazing group of people.
                                Being open source means Webiny grows and evolves much faster.&nbsp;
                                <a
                                    onClick={() => {
                        ...
                        <ReasonBox>
                            ...
                            <p className="text">
                                ...
                                . Talk to the core-team, and get help. Webiny team is always there
                                for any questions.
                            </p>
                        </ReasonBox>
                    </Wrapper>
