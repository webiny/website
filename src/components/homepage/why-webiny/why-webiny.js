        ...
        return (
            <section {...this.props} className={wrapperClass}>
                ...
                <ContentContainer>
                    <Grid>
                        <Cell>
                            <img className={"image-small"} src={imgCommunityTools} />
                        ...
                        <Cell>
                            <img className={"image-small"} src={imgMicroservices} />
                        ...
                        <Cell>
                            <img className={"image-small"} src={imgMultiCloud} />
                            <h3>
                    ...
                    <Grid>
                        <Cell>
                            <img className={"image-small"} src={imgSls} />
                        ...
                        <Cell>
                            <img className={"image-small"} src={imgCompleteEnv} />
                        ...
                        <Cell>
                            <img className={"image-small"} src={imgJs} />
