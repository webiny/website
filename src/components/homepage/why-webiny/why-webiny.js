        ...
        <ContentContainer>
          <Grid>
            <Cell>
              ...
              <p>
                We created Webiny with developers in mind. It’s a single
                platform built with community accepted tools and libraries.
              </p>
            </Cell>
            <Cell>
              <img
            ...
            <Cell>
              ...
              <p>
                Deployed Webiny to any of the major cloud providers, like AWS,
                GCP or Azure.
              </p>
            </Cell>
          </Grid>
          <Grid>
            <Cell>
              ...
              <p>
                Webiny makes it easy to build websites, web applications, APIs
                and microservices inside the serverless environment.
              </p>
            </Cell>
            <Cell>
              <img
              ...
              <p>
                ...
                configure webpack, babel, routing and other stuff. All you need
                is already there.
              </p>
            </Cell>
            <Cell>
              ...
              <p>
                One language is all you need to know, no matter if you’re coding
                a SPA or an API.
              </p>
            </Cell>
          </Grid>
