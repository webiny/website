        ...
        <ContentContainer>
          <Grid className={"first"}>
            ...
            <Cell className={"headingCell"}>
              ...
              <p>
                ...
                allowing you to build more engaging pages and present your content in the
                way it deserves. Your users will thank you.
              </p>
            </Cell>
          </Grid>
          <Grid>
            ...
            <Cell>
              ...
              <p>
                Days of complex template engines, file includes and special variable tags are over.
                Building a theme for Webiny is nothing more than plain old (S)CSS.
                For a designer, this means that the learning curve is minimal.
              </p>
            </Cell>
          </Grid>
          ...
          <Grid>
            ...
            <Cell>
              ...
              <p>
                How many times did you have two tabs opened, one for writing content, and the other one for viewing how
                the content looked like inside your theme and page layout? To get arround that hassle, Webiny features
                Live Preview, where it can render your whole page inside the editor to get the real sense of how the content looks like.
              </p>
            </Cell>
            <Cell>
              <h3>
