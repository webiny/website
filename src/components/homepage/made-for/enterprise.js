...
export default ({children, ...props}) => (
  <React.Fragment>
    ...
    <SubText>
      ...
      Empower your developers and benefit from their increased productivity.
    </SubText>
    <List>
      <ListItem>
        <Bold>Governance</Bold>
        {' '}
        - Control which teams have access to which properties. Fence
        off production access from staging and other environments.
      </ListItem>
      <ListItem>
        <Bold>Dedicate deployment</Bold>
        {' '}
        - A deployment with no other tenants. Ability to
        choose from any of the AWS regions, or use your own.
      </ListItem>
      <ListItem>
        <Bold>Cost & Scalability</Bold>
        {' '}
        - Embrace the benefits that serverless brings. Almost
        instant scale and tremendous cost savings, when compared to a traditional VPS.
      </ListItem>
    </List>
    <Buttons>
