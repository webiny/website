...
const howHard = (
  <React.Fragment>
    ...
    <p>
      ...
      {' '}
      which is full of guides and
      examples to help you out in case you need extra pointers
    </p>
    <p>
      Finally, you can use the
      {' '}
      <a href="https://community.webiny.com/">community forum</a>
      {' '}
      to
...
const howToSupport = (
  <React.Fragment>
    ...
    <p>
      ...
      <Link to="/pricing">paid package</Link>
      . This ensures a steady revenue flow, so our
    ...
    <p>
      ...
      <a href="https://docs.webiny.com/docs/other/contributing">this page</a>.
    </p>
  </React.Fragment>
);
