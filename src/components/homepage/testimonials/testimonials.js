      ...
      <section {...this.props} className={wrapperClass}>
        ...
        <ContentContainer className={quoteList}>
          <Quote name={"@pierkarski"}>
            Thank you for filling a much needed void. This is by far the best
            serverless cms architecture out there.
          </Quote>
          <Quote name={"@kisg"}>
            Thank you for all your great work on Webiny! It’s a beautiful piece
            of software.
          </Quote>
          <Quote name={"@brett"}>
            I truly believe this infrastructure is the future for web dev.
            Thanks for the amazing tool you have built.
          </Quote>
          <Quote name={"@robotrekker"}>
            You guys are awesome. Love, love, love this project.
          </Quote>
          <Quote name={"@tmikaeld"}>
            My god. What you're building here beats everything I've seen in a
            looong time.
          </Quote>
          <Quote name={"@dan"}>
