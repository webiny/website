            ...
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    ...
                    <Body>
                        ...
                        provides you with developer tools, libraries, ready-made apps and processes specifically
                        created for serverless development. It's built on top of AWS cloud and uses the latest
