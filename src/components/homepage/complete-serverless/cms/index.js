...
const navigationContent = [
    ...
    },
    {
        ...
        description:
            "Using a powerful solution such as Webiny, requires an equal security layer and we have built one just for that purpose. On the backend Webiny uses AWS Cognito as an IdP, and for enterprise customers we provide additional implementations.",
        relatedList: [
