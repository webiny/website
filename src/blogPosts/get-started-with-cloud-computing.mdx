...
Now that you know the cloud computing concepts, I think you are ready to start with some examples of cloud computing services or you can follow the blog on <ExternalLink href="https://webiny.com/blogs">5 AWS services you need for web development</ExternalLink>!
