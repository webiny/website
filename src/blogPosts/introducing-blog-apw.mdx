...
featured: false
---
Creating engaging content, quality control, approval and publishing could take a long time, a luxury which organizations cannot afford. The ever more sophisticated needs of their customers put the price of delayed delivery way too high.

Companies cannot compromise quality for speed so we have created the Advanced Publishing Workflow to streamline the numerous content reviews and approvals which are required to ensure the high quality of the final published content.

In this blog you will see how to:
- Set up the publishing workflow
- Submit a record for review
- Review, submit changes and provide sign off

## Why Did We Create the Advanced Publishing Workflow?
Imagine you are designing a nuclear power plant. All the design documents have to be carefully reviewed by two, three, in some cases dozens of reviewers to ensure various elements of the design are fit for purpose. This process could take weeks, if not months, before the documents are ready to be released to manufacture or building contractors. Collaborating and commenting on the same document could be difficult to manage with so many reviewers. Changes to design could happen at any point in time, and have to be addressed before the documents receive final approval. Compromising with the quality and safety of the design is simply unthinkable. 

The challenge most organizations operating in the fast-paced digital world is that such delays are unacceptable. Sometimes organizations have a few hours to create and publish content, especially if they want to be at the forefront of their industry. But how one can get the speed and still not compromise on quality?

With the **Advanced Publishing Workflow**, we allow organizations to:

- Set up an efficient and flexible approval process which fits their existing procedures and requirements;
- Notify reviewers and authors automatically when there are pending actions on their side to accelerate the review process;
- Enable individual contributors to comment and communicate live with their authors or reviewers;
- Keep a track record of the feedback provided during the review and changes made as a result.
...
Here is how you set this up in the system:
