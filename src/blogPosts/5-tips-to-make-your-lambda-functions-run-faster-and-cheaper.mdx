...
Configuring Webpack could be a bit daunting task, but it's definitely worth it at the end of the day. Luckily, with every <ExternalLink href="https://docs.webiny.com/docs/get-started/quick-start/?utm_source=Webiny-blog&utm_medium=webiny-blog&utm_campaign=webiny-hygiene-blog-oct-19&utm_content=webiny-5-tips-lambda-functions-run-faster-cheaper&utm_term=W00227">new Webiny project</ExternalLink>, the bundling process is pre-configured for you, so you can immediately jump to your new project! 😊
...
I won't go too much into the details here (feel free to check the <ExternalLink href="https://www.webiny.com/serverless-app/page-builder/?utm_source=Webiny-blog&utm_medium=webiny-blog&utm_campaign=webiny-hygiene-blog-oct-19&utm_content=webiny-page-builder-serverless-page&utm_term=W00229">Serverless Side Rendering - The Ultimate Guide </ExternalLink> article for that, but, what we are doing with the two Lambda functions is essentially splitting work and optimizing for cost. The **Web Server Lambda** is configured with minimal system resources (256MB RAM), because its only task is to return cached SSR HTML, stored in the database.
