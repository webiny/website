...
(💡 Quick tip: For easier local development, make sure you utilize the [`nodemon`](https://www.npmjs.com/package/nodemon) library.
...
![Debufg configuration](./assets/debug-locally-running-nodejs-express-app-webstorm/debug-configuration.gif)
