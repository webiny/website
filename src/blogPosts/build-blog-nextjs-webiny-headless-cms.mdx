...
Now that you have seen the basic functions of the files in the structure, let's start by taking a look at the `fetcher` and GraphQL query functions. We won't be focusing more on the styling of this blog, but, if you want to get a hold of the styles, you can check them out in the [repository](https://github.com/kaf-lamed-beyt/wbny-cms-blog)
