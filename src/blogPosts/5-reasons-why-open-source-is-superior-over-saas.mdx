...
- Open source software (OSS) is a type of computer software in which source code is released under a license in which the copyright holder grants users the rights to use, study, change, and share the software in modified and unmodified form.
...
Open source gives you exactly that flexibility that you need. A well-structured software that solves your main problem, but with an opportunity to completely adapt it to exactly fit your needs. Which also expands into freedom to expand the code without having to rely on the software vendor to make the change - no vendor lock-in.

### Transparency

With open source, you can know exactly what you are getting. Your team of developers go through the code and can see exactly what the software does. And how it does it, how it could integrate with other technologies you are using, whether it comes with any potential security risks. The list goes on.
...
Webiny Slack community - <ExternalLink href="https://webiny.com/slack?utm_source=Webiny-blog&utm_medium=webiny-slack-community&utm_campaign=webiny-daily-posts-dec-21&utm_content=webiny-slack-community&utm_term=W00450">here</ExternalLink>

Webiny GitHub - <ExternalLink href="https://github.com/webiny/webiny-js?utm_source=GitHub&utm_medium=webiny-github&utm_campaign=webiny-daily-posts-dec-21&utm_content=webiny-github-repo&utm_term=W00451">here</ExternalLink>

---

References: Linus's law - <ExternalLink href="https://en.wikipedia.org/wiki/Linus"> Linus's law</ExternalLink>
