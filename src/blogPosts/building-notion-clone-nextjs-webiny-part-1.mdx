...
featureImage: "./assets/building-notion-clone-nextjs-webiny/cover-part-1.png"
author: sachinmmane
date: 2024-06-24
tech: ["Next.js"]
---
...
<video width="800px" height="auto" controls autoplay>
  <source src="./assets/building-notion-clone-nextjs-webiny/notion-clone-demo.mp4" type="video/mp4" />
</video>
...
![Access Management / Roles](./assets/building-notion-clone-nextjs-webiny/roles-creation-step-1.png)
...
![Role Details](./assets/building-notion-clone-nextjs-webiny/roles-creation-step-2.png)
...
![Headless CMS permissions](./assets/building-notion-clone-nextjs-webiny/roles-creation-step-3.png)
