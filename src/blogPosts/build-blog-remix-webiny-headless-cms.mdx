...
title: "Build a ToDo App with Remix and Webiny Headless CMS"
...
![Creating the Posts content model](./assets/build-blog-remix-webiny-headless-cms/posts-content-model.png)

Don’t forget to reference the author field by clicking on Content Models as shown in the image below.

Populating the Posts content type
...
`npx create-remix <NAME OF YOUR APP>`
...
`REMIX_PUBLIC_WEBINY_API_URL=paste-your-apiUrl-here`
...
The complete code for this article can be found [here](https://github.com/IsaacThaJunior/Remix-blog-and-Webiny).