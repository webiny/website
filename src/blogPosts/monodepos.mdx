...
slug: "blog/monorepos"
title: "Monorepos"
description: "In this article, you'll learn what monorepos are, their advantages and disadvantages, as well as the tools you can use to easily set up monorepos for your system."
...
You may already have heard about monorepos. In case you haven't, monorepos stand for keeping all of an organization's code in one repository. 
You might be wondering what is the reason we picked the open-source to talk about monorepos? 
Because there are very famous open-source projects like Babel, React, Jest, Vue, Angular who use the monorepo architectural pattern to organized the codebase.

In this article, you'll learn what monorepos are, their advantages and disadvantages, as well as the tools you can use to easily set up monorepos for your system.
