...
Welcome to the second part of tutorial series on how to build a Trello clone with Next.js and Webiny Headless CMS.
[In previous tutorial](/blog/build-trello-clone-nextjs-webiny-headless-cms-1-of-2/), we've built board-related functionality and in the second part of this tutorial,
