...
This is where we will add a new product to the Webiny CMS. As a standard practice we will test the mutation on the Webiny API Playground shown below:
...
This is the GraphQL syntax we will use to create a new project. We will also make a query on our Categories Model so that we can use the results as option in our form. Test it as shown below:
...
Here is the GraphQL query for all categories:
