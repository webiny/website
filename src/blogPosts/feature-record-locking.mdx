...
**- Option 2:** In cases of urgency or if Sally is not available, for example she has gone for a lunch break, but left her browser open on the record, Tom could take over the record and proceed with his edits, only if he has the correct security permissions in his Role. Alternatively, Tom can contact a system admin to get the record unlocked. The higher permission rights are required to avoid unintended data loss. If Sally has any unsaved changes, then they would be lost. Users should periodically save their changes to avoid losing their work.
