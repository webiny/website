...
**Caution! This will allow anyone who has your API key and API URL to modify the data in your Webiny instance. If you are using Webiny for anything other than this content model, we recommend you assign the To Do content model to a group, and restrict API access to that model and content only.**
