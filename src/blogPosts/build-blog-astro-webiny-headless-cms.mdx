...
description: "Webiny’s secure, scalable, high-performance GraphQL API is a great choice to build your next Astro project. Check out this guide to building with Webiny Headless CMS and Astro."
