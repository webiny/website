...
`gist:AlbionaHoti/3248bb31ba4192d2fe7076d3ca24c285`
...
Navigate to the `localhost:3000` and check your products rendering on the product cards 🚀 🚀
...
`gist:AlbionaHoti/2ed7c2e78cae3c5da365ce82cf437fca`
...
> Note: Provide your Stripe `secret key` on the 3rd line
...
Now lets head over to the console on the developer tools of chrome and test 🙂
