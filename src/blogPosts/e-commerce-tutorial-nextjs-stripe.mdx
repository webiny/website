...
> For the sake of the time-saving, we will link all the component files with the GitHub links for you to go through
...
When building a website, you have to decide how you are going to create your frontend, what library are you going to use? Do you need to start building it from scratch?
Which UI framework is the fastest to set up and learn how to use? etc.
If you are in a hurry for your project idea, well, there are numerous of UI frameworks 🚀
...
- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/pages/index.js">
    Home page
  </ExternalLink>
...
- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/pages/checkout.js">
    Checkout page
  </ExternalLink>

![Checkout page](/assets/e-commerce-tutorial-nextjs-stripe/checkout_page.png)

We mentioned that the `checkout` page is one of the most important ones because, at the `checkout` page, we will use the Next.js `getServerSideProps` lifecycle method to perform server-side only behavior. With this lifecycle method, we don't need to create an API to handle the intent creation (for the Stripe integration) that will be handled directly inside our checkout page.
...
- **?**<ExternalLink href="">Product page</ExternalLink> - `hacktoberfest` issue
  ...
  For now, the e-commerce starter project doesn't have a `product` page. If you are interested to contribute you can go through the GitHub issue <ExternalLink href="http://www.github.com/webiny">here</ExternalLink>.

### ANTD Components

The <ExternalLink href="https://ant.design/">antd</ExternalLink> provides plenty of UI components to enrich your web applications, for this project we will use several Ant design react components, such as: `Grid`, `Menu`, `Layout`, `List`, `Cart`, `Modal`, etc.

- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/ProductCard.js">
    Product Card
  </ExternalLink>
...
- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/ProductList/index.js">
    Product List
  </ExternalLink>

![Product List](/assets/e-commerce-tutorial-nextjs-stripe/product_list.png)

- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/LayoutContent.js">
    Layout Component
  </ExternalLink>

- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/HeaderComponent.js">
    Header Component
  </ExternalLink>

![Header component](/assets/e-commerce-tutorial-nextjs-stripe/header_component.png)

- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/CategoriesMenu.js">
    Categories Component
  </ExternalLink> - Menu

![Categories component](/assets/e-commerce-tutorial-nextjs-stripe/categories_component.png)

- <ExternalLink href="https://github.com/webiny/webiny-examples/blob/master/webiny-starter-e-commerce-nextjs-stripe/frontend/components/Cart.js">
    Products Cart
  </ExternalLink>

![Products cart](/assets/e-commerce-tutorial-nextjs-stripe/products_cart.png)
