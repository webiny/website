...
TLDR; <ExternalLink href="https://github.com/webiny/e-commerce-starter">Get the code here</ExternalLink>
...
Now that we've seen what the `_app.js` includes, of let's dig into the actual GraphQL client file.
...
> This year Webiny is participating in the <ExternalLink href="https://www.webiny.com/blog/webiny-hacktoberfest-2020"> Hacktoberfest 2020 </ExternalLink> - Join us on developing the leading serverless framework ⚡️
