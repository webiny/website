...
Webiny is an open-source enterprise CMS that marries flexibility with robustness. It’s open-source like Strapi, yet auto-scales like Contentful, at a fraction of the cost. It offers enterprise-grade security features like Contentful, allowing you to self-host like Strapi.
...
However, if compromise isn’t on your agenda, Webiny is a compelling alternative. It scales as well as Contentful at a fraction of the cost and is just as customisable as Strapi, if not more so. Moreover, it also offers some unique features that both Strapi and Contentful lack, such as multi-tenancy and IaC capabilities.
