...
We will be creating a news application that allows you to view images, title text with descriptions, date of publishing, the authors, and a link that can be clicked manually to navigate to the full story or can be navigated for you by sending speech commands using the Alan Ai. To follow along, the following are required: 
...
## Putting our Webiny CMS together
...
This should automatically set up your project. You will be requested to select an AWS region and a database your project will be deployed with. For this project, we will be using DynamoDB as we are building a small project.  Once created, navigate to the folder and input the command below.
...
## Inputting data into our models
...
[React App - Google Chrome 2022-10-13 01-26-27_Trim.mp4](./assets/build-voice-controlled-news-app-alanai-webiny/React_App_-_Google_Chrome_2022-10-13_01-26-27_Trim.mp4)
