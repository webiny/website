...
Going through my calendar, in the last 8 months, I had 179 calls with potential clients and users of Webiny. Some were small web agencies, others were a Fortune 500 business. Through those calls, I've noted down over 1000 lines of feedback items.
...
- 🚀 Drastic performance improvements (bechmark included below)
...
Pretty much the #1 top requested feature is now implemented. Webiny by default ships with DynamoDB. For this, we had to rewrite all of our apps, from Page Builder to Headless CMS, and completely change the way how we store and retrieve content from the database.
...
Here's a quick snapshot of the architecture, for the full overview, checkout [this page](https://docs.webiny.com/docs/key-topics/cloud-infrastructure/introduction).
