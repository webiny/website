...
AWS re:Invent 2020 is the Amazon Web Services (AWS) annual conference, one of the largest in the world. Focusing on Cloud strategies, cloud operations, security and developer productivity, IT architecture, and infrastructure.

Usually, the event is organized on-site in Las Vegas where it welcomes over 60.000 attendees for a few days. This year, the event was fully virtual, and it lasts for three weeks from November 30 to December 18, 2020.

In this article, we're going through Webiny's top 5 picks on serverless announcements ⬇️
...
### 1.2. Lambda now supports 10GB memory and 6 vCPU cores for Lambda Functions
...
For more details, check out the article <ExternalLink href="https://aws.amazon.com/about-aws/whats-new/2020/12/introducing-the-next-version-of-amazon-aurora-serverless-in-preview/">here</ExternalLink>.
