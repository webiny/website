...
title: "Building a Notion Clone with Next.js and Webiny: Part 2"
description: "In this tutorial, we will build the frontend of our Notion Clone using Next.js."
tags: ["Next.js", "build projects", "contributed articles"]
featureImage: "./assets/building-notion-clone-nextjs-webiny/cover-part-2.png"
author: sachinmmane
date: 2024-08-20
tech: ["Next.js"]
---
...
![Wotion Home](./assets/building-notion-clone-nextjs-webiny/wotion-home.png)
...
export const Navbar = () => {const scrolled = useScrollTop();
    return ( <div className={cn( "z-50 bg-background fixed top-0 felx items-center w-full p-6", scrolled && "border-b shadow-sm" )} >
       <Logo />
    </div> ); };
```
