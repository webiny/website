...
Before running the **Extend Admin Area** scaffold, we will first run the following two [`webiny watch`](https://www.webiny.com/docs/core-development-concepts/basics/watch-command) commands:
