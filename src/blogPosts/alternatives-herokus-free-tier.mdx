...
If this is what you're looking for, there are a host of new services like [Fly.io](https://fly.io/), and [Render](https://render.com/), both of which deploy containerized applications and that offer free tiers with different pricing models depending on what services and persistent storage you require.
...
- [Speed up a Heroku App with Fly](https://fly.io/docs/app-guides/speed-up-a-heroku-app/)
