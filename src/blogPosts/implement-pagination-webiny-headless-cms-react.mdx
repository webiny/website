...
description: "Working with large data sets, fetching and rendering them at once could cause some negative effects. A common practice of mitigating those is using pagination. In this tutorial, we are going to learn how to implement pagination when using Webiny headless CMS in React."
...
Working with large data sets, fetching and rendering them at once could cause some negative effects like the slow loading of components which causes a bad user experience.
A common practice of handling this is using pagination.

In this tutorial, we are going to learn how to implement pagination when using [Webiny headless CMS](https://www.webiny.com/docs/overview/applications/headless-cms) in React.
...
![successful-deploy.png](./assets/implement-pagination-webiny-headless-cms-react/successful-deploy.png)
...
![welcome-screen.png](./assets/implement-pagination-webiny-headless-cms-react/welcome-screen.png)
...
![new-content-model.png](./assets/implement-pagination-webiny-headless-cms-react/new-content-model.png)
...
![create-fields.png](./assets/implement-pagination-webiny-headless-cms-react/create-fields.png)
...
![title-field-dnd.gif](./assets/implement-pagination-webiny-headless-cms-react/title-field-dnd.gif)
...
![title-field.png](./assets/implement-pagination-webiny-headless-cms-react/title-field.png)

Below are all the fields for the Book model. After creation, click on the **SAVE** button at the top right of the page.

![completed-model-fields.png](./assets/implement-pagination-webiny-headless-cms-react/completed-model-fields.png)
...
![book-model-page.png](./assets/implement-pagination-webiny-headless-cms-react/book-model-page.png)
...
![add-entry.png](./assets/implement-pagination-webiny-headless-cms-react/add-entry.png)
...
```bash
npx create-react-app webiny-pagination

cd webiny-pagination
```

For working with GraphQL in our frontend we will be using [Apollo client](https://www.apollographql.com/docs/react/).Let's install those into our project:
...
![frontend-list.png](./assets/implement-pagination-webiny-headless-cms-react/frontend-list.png)
...
![api-keys-location.png](./assets/implement-pagination-webiny-headless-cms-react/api-keys-location.png)
...
![api-new-api-key.png](./assets/implement-pagination-webiny-headless-cms-react/api-new-api-key.png)

Enter a name and description then scroll down the page, expand the **Content** tab and select **All locales.**

![api-cms-all-locales.png](./assets/implement-pagination-webiny-headless-cms-react/api-cms-all-locales.png)

Next, expand the **Headless CMS** tab which contains options to control which operations the API token can, or cannot, perform.

![api-cms-access-level.png](./assets/implement-pagination-webiny-headless-cms-react/api-cms-access-level.png)
...
![api-cms-read-access.png](./assets/implement-pagination-webiny-headless-cms-react/api-cms-read-access.png)

![api-cms-access-specific-content-models.png](./assets/implement-pagination-webiny-headless-cms-react/api-cms-access-specific-content-models.png)

After setting the controls, click on the **SAVE API KEY** button at the bottom of the page and our API token will be created.

![new-token.png](./assets/implement-pagination-webiny-headless-cms-react/new-token.png)
...
![gql-api-read-url.png](./assets/implement-pagination-webiny-headless-cms-react/gql-api-read-url.png)
...
![prev-next-buttons.png](./assets/implement-pagination-webiny-headless-cms-react/prev-next-buttons.png)
...
**Full source code:** https://github.com/webiny/write-with-webiny/tutorials/pagination-react
