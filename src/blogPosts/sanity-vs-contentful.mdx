...
![Sanity Pricing](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/sanity-pricing.png)

#### Contentful

![Contentful Pricing](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/contentful-pricing.png)

## Webiny – The alternative everyone is talking about

![Webiny](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/webiny.png)
...
![Complete End-To-End Serverless Experience](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/serverless.png)
...
![Serverless Architecture](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/serverless-architecture.png)
...
![Cost Saving with Serverless](./assets/build-a-multilingual-blog-with-webiny-headless-cms-and-vue/cost-saving-with-serverless.png)
