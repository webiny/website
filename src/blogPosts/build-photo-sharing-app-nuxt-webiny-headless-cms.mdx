...
ghLink: "https://github.com/webiny/write-with-webiny/tree/main/tutorials/photo-sharing-app-nuxtjs"
---
...
_🚨Note that the first deployment can take up to 20 minutes! So, even though it might look like nothing is happening in the terminal, please be patient and let the process finish. If something went wrong, an error will be shown._
...
![./assets/build-photo-sharing-app-nuxt-webiny-headless-cms/nuxt-ui-file-upload.gif](./assets/build-photo-sharing-app-nuxt-webiny-headless-cms/nuxt-ui-file-upload.gif)
...
**Full source code:** https://github.com/webiny/write-with-webiny/tree/main/tutorials/photo-sharing-app-nuxtjs
