...
description: "While a to-do application can easily be developed using a front-end development framework such as React.js, viewing and managing its content is not feasible if it's hard coded.A good implementation that can seamlessly handle this task is using a Content Management System such as the Webiny Headless CMS."
...
<video>
<source src="./assets/todo-application-react-tailwind-webiny-headless-cms/create-a-new-todo.mp4" controls type="video/mp4">
</video>
...
<video>
<source src="./assets/todo-application-react-tailwind-webiny-headless-cms/delete-todo-item.mp4" controls type="video/mp4">
</video>
...
<video>
<source src="./assets/todo-application-react-tailwind-webiny-headless-cms/final-video.mp4" controls type="video/mp4">
</video>
